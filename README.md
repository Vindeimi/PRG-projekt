...
Před zahájením práce si prosím přečtěte dokumenty **[CODING_STANDARDS jsou důležité](CODING_STANDARDS.md)** a **[Práce s Gitem](PRACE_S_GITEM.md)**. Je důležité, aby každý člen týmu dodržoval stanovené konvence a pravidla pro spolupráci.
